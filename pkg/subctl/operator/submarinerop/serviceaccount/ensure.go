...
func getLighthouseOperatorClusterRoleBinding(namespace string) (*rbacv1.ClusterRoleBinding, error) {
	...
	clusterRoleBinding := &rbacv1.ClusterRoleBinding{}
	err := embeddedyamls.GetObject(embeddedyamls.Submariner_lighthouse_operator_cluster_role_binding_yaml, clusterRoleBinding)
	if err != nil {
		return nil, err
	}
	clusterRoleBinding.Subjects[0].Namespace = namespace
...
func getLighthouseOperatorClusterRole() (*rbacv1.ClusterRole, error) {
	...
	role := &rbacv1.ClusterRole{}
	err := embeddedyamls.GetObject(embeddedyamls.Submariner_lighthouse_operator_cluster_role_yaml, role)
	if err != nil {
		return nil, err
	}
	return role, nil
